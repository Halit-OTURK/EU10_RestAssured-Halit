...
public class SpartanTestsWithParameters {
    ...
    public void test1(){
        ...
        Response response = given().
                                      ...
                                      .and().pathParam("id", 5)
                            .when() // and. and .when for readable like gherkin language
                                     .get("/api/spartans/{id}");
        //verify status code
    ...
    @Test
    public void test3(){
    Response response= given().log().all(). // to see all of => log().all().
                                accept(ContentType.JSON)
...
/*
Request method:	GET
Request URI:	http://3.216.30.92:8000/api/spartans/search?nameContains=e&gender=Female
Proxy:			<none>
Request params:	<none>
Query params:	nameContains=e
				gender=Female
Form params:	<none>
Path params:	<none>
 ...
 */
    ...
    // same test written with MAP COLLECTION !!!
