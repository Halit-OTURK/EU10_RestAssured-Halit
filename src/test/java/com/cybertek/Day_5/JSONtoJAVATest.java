...
public class JSONtoJAVATest extends SpartanTestBase {
    ...
    public void oneSpartanToMap(){
        ...
        Map<String,Object> jsonMap = response.body().as(Map.class); // have to add new dependency jackson databind
    ...
    public void getAllSpartan(){
        ...
        System.out.println("jsonList.get(2).get(\"name\") = " + jsonList.get(2).get("name"));
        System.out.println("jsonList.get(2).get(\"gender\") = " + jsonList.get(2).get("gender"));
